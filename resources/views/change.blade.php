...
@section('content')
    <div class="container">
        ...
        <form class="needs-validation" novalidate="" method="post" action="{{ route('change_id', $albums->id)}}" enctype="multipart/form-data">
            @csrf
            <div class="row g-2">
                <div class="col-6">
                ...
                <div class="col-12">
                    ...
                    <textarea type="text" class="form-control" id="descr" name="descr" placeholder="{{$albums->descr}}" value="{{$albums->descr}}">{{$albums->descr}}</textarea>
                </div>
                <div class="col-12">
